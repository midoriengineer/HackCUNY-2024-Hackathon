    ...
    return ( 
        <div className='bg-white rounded-2xl max-w-fit mx-auto my-8 shadow-2xl'>
            <div className='max-w-[1200px] mx-auto grid md:grid-cols-2'>
                ...
                <button onClick={handleGoogleSignIn} type="button" className="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center w-[185px] dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
